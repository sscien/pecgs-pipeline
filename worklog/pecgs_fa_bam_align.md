...
BamPathFile="${outdir}/PECGS_batch1_re_aligned_bam_v3.txt"
...
# edit wes_coverage_from_table.sh
...
condapython
conda activate base
python plot-dist.py ../*.region.dist.txt >coverage_results_pecgs_align_v4.tsv
