...
python ../../src/compute1/generate_run_commands.py make-run --sequencing-info  sequencing_info.txt pecgs_TN_wxs_fq_T_rna_fq run_list.txt /storage1/fs1/dinglab/Active/Projects/estorrs/pecgs-pipeline/examples/ht191/example_run
